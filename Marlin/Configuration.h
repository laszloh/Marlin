...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp 4.69
  #define DEFAULT_Ki 0.79
  #define DEFAULT_Kd 12.5
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 10, 45, 45 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 500, 8000, 8000 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -14, 10, 0 }
